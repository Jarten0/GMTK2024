...
func _ready() -> void:
	...
	# post-intro text
	lines[17] = "Drag a token onto an object to change its size."
	lines[19] = "You can use WASD to change course. Be warned, you have limited uses."
	lines[19] = "You can use WASD to change course. Be warned, you have limited uses."
	lines[20] = "Now, get a move on! We don't have much time."
	lines[21] = "Watch for those springs. They'll push you off the path."
	lines[22] = "Spikes are dangerous, and will destroy the truck."
	lines[23] = "Those purple arrow things'll spin stuff round. Be careful."
	lines[24] = "Oh, right. Make sure the key you put in is the same size as the gate itself."
	lines[25] = "God these security measures are stupid. Who thought to put a truck-harnessed-key gate here anyways?!"
